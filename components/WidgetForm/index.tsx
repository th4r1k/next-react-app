...
export function WidgetForm() {
  return (
    <div className="relative mb-4 flex w-[calc(100vw-2rem)] flex-col items-center rounded-2xl bg-gray-800 p-4 shadow-lg dark:bg-gray-400 md:w-auto">
      <header>
        <span className="text-xl font-bold leading-6 text-gray-400 dark:text-gray-800">
          Social Media
        </span>
        <CloseButton />
      </header>
      ...
      <div className="flex w-full gap-2 py-8">
        <a
          target="_blank"
          href="https://github.com/th4r1k"
          className=" flex w-24 flex-1 flex-col items-center gap-2 rounded-lg border-2 border-transparent py-5 hover:border-gray-400 dark:hover:border-gray-800"
        >
          <svg
            id="github"
      ...
      <footer className="text-xs text-neutral-400">Tharik Honda</footer>
    </div>
  )
}
