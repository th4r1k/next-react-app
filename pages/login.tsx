    ...
    <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      ...
      <div className="p-5">
          <div className="flex gap-1 justify-between">
              <button onClick={()=> signIn("google")} type="button" className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Login with Google </button>
              <button type="button" className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Create Account</button>
          </div>
      </div>
        <div className="py-5">
